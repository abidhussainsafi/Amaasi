...
<div class="main" id="main">
        ...
        <div class="four_blocks">
            ...
            <div class="row">
                <div class="scrolling_text">
                    ...
                    <div  id="top" class="callbacks_container">
                        ...
                        <ul class="rslides" id="slider4">
                            ...
                            $posts = new WP_Query(array('post_type' => 'ammslider','taxonomy' => 'cat_slide', 'term' => 'wedding-en'));
             ...
             <p><span><?php echo get_post_meta(get_the_ID(),'description_sub_title',true);?></span></p>
                                            ...
                                            <a href="mailto:info@amassicatering.com" class="btn"><i class="fa fa-email"></i>info@amassicatering.com</a>
    ...
    <div class="parallex parallax-window" data-parallax="scroll" data-image-src="<?php echo TEMPLATE_PATH;?>images/inner_paralex.jpg">
        ...
        <div class="container">
            ...
            <div class="block_eight row inner_right_block">
                ...
                $posts = new WP_Query(array('post_type' => 'parallax','taxonomy' => 'cat_parallax', 'term' => 'wedding-en','order'=>'ASC'));
    ...
    <div class="container">
        ...
        <div class="block_four">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                <div class="block_one_of_four" style="background:url(<?php echo TEMPLATE_PATH;?>images/weddings_1.jpg) -293px 0px;">
                    <div class="inner">
                    <p>MAIN COURSE</p>
                    </div><!--END OF INNER-->
                </div>
                ...
                <div class="col-md-6">
                        <div class="block_center_of_one" style="background:url(<?php echo TEMPLATE_PATH;?>images/weddings_2.jpg) 0 -134px;">
                            <div class="inner">
                                <p>COLD MEZZE</p>
                            </div><!--END OF INNER-->
                         </div>
                    <!--END OF BLOCK CENTER OF ONE-->

                    <div class="block_center_of_two" style="background:url(<?php echo TEMPLATE_PATH;?>images/weddings_3.jpg) 558px -58px; background-size:572px;">
                    <div class="inner">
                ...
                <div class="col-md-3">
                    ...
                    <div class="block_one_of_four" style="background:url(<?php echo TEMPLATE_PATH;?>images/weddings_4.jpg) -140px 0px;">
                <div class="inner">
                    <p>HOT MEZZE</p>
                    </div><!--END OF INNER-->
